(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        if (totalPage > 0) {
            var html = [];
            html.push('<div class="col-md-5 col-sm-12">');
            html.push('<div class="dataTables_info">');
            
            html.push('共'+totalPage+'页'+totalCount+'条');
            html.push('</div></div>');
            
            html.push('<div class="col-md-7 col-sm-12">');
            html.push('<div class="dataTables_paginate paging_bootstrap">');
